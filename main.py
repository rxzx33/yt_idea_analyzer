...
if __name__ == '__main__':
    ...
    if youtube_service:
        ...
        search_results = search_youtube_videos(youtube_service, search_query, max_results=30)
        ...
        if search_results:
            ...
            if video_details:
                ...
                if analysis_output:
                    ...
                    while True:
                        try:
                            subscriber_count = int(input("Jumlah Subscriber (perkiraan): ") or "0")
                            break
                        except ValueError:
                            print("Masukkan angka yang valid.")
                    
                    print("\n--- Target Audience ---")
                    age_range = input("Rentang Usia (contoh: 18-35): ").strip()
                    geography = input("Geografi (contoh: Indonesia, Malaysia): ").strip()
                    interests = input("Minat (contoh: Teknologi, Hiburan): ").strip()
                    ...
                    **PENTING**: Evaluasi ide konten ini berdasarkan kriteria berikut:
                    ...
                    4. **UKURAN CHANNEL** - Apakah channel saya (dengan {channel_context_data.get("subscriber_count", 0):,} subscriber) memiliki peluang yang realistis untuk bersaing di topik ini?
                    ...
                    **RESPONSE FORMAT:**
                    ...
                    [❓ Mengapa?]:
                    [Jelaskan alasan utama untuk keputusan di atas secara ringkas. Fokus pada DEMAND, KOMPETISI, RELEVANSI, dan UKURAN CHANNEL. Beri penilaian yang jujur dan realistis. Contoh: "Permintaan tinggi, kompetisi moderat, sangat cocok dengan niche Anda, dan sesuai untuk channel berukuran {channel_context_data.get("subscriber_count", 0):,} subscriber." atau "Permintaan ada tapi kompetisi terlalu tinggi untuk channel kecil." atau "Topik tidak relevan dengan audiens Anda."]
